...
<body>
    ...
    <div class="layui-row layui-form">
        <div class="layui-col-md12">
            ...
            <div class="layui-btn-group">
                ...
                <?php if($_SESSION['admin_id']== "root"): ?><button class="layui-btn layui-btn-sm layui-black " data-tips='3' data-color='#666' title='新增栏目' id="add">
    ...
    <script type="text/html" id="bar1">
        ...
        <?php if($_SESSION['admin_id']== "root"): ?><a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" data-tips='2' data-color='rgb(253, 51, 51)' title='删除'>
               <i class="layui-icon">&#xe640;</i>
            </a><?php endif; ?>
    ...
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            table.on('tool(table_filter)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'edit') {
                    //管理轮播图
                    window.open('/xq/index.php/Admin/Nav/edit/nav_id/' + data.nav_id);
                }
