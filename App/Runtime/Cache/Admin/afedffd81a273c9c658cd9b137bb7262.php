    ...
    <div class="o-panel">
        ...
        <div class="o-panel-body">
            ...
            <form class="layui-form">
                ...
                <div class="form-group">
                    <label>文章详情</label>
                    <script id="container" name="info_content" type="text/plain" style="width:100%" lay-verify='required'><?php echo (htmlspecialchars_decode($info["info_content"])); ?></script>
                </div>
                <div class="form-group">
                    <label> </label>
                    <div class="text-right">
        ...
        layui.use(['form', 'upload'], function () {
            ...
            (function () {
                ...
                var fun = function (res) {
                    ...
                    var arr = [];
                    arr[0] = res.msg;
                    linkage(arr, form, ['<?php echo ($info["nav_id"]); ?>']);
