...
<script>
    ...
    <link href="/xq/Public/Admin/dist/index/index.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="o-nav">
        <div class="o-nav-left">

            <div class="o-nav-item">
                <a href="javascript:;" data-src='Index/home'>
        ...
        <div class="o-nav-right">
            <div class="o-nav-item">
                <a href="javascript:;" data-src=' '>
                    ...
                    <img src="/xq/<?php echo (session('admin_head_img')); ?>" alt=""><?php echo (session('admin_name')); ?>
                    <!-- <span class="spot spot-danger"></span> -->
                </a>
                <div class="o-nav-item-s">
                    <ul>
                        <!-- <li>
                            <a href="">
                        ...
                        <li class="line"></li>
                        <li>
                            <a href="/xq/index.php/Admin/Login/sinOut">
    ...
    <div class="o-nav-list">

        <div class="o-nav-item">
            <a href="" class="o-nav-logo">
                <!-- <i class="fa fa-home"></i> -->
                信雀
            </a>
        ...
        <div class="o-nav-item">
            ...
            <div class="o-nav-list-s">
                <ul>
                    <li>
                        <a href="/xq/index.php/Admin/info/add" target="_black" ddata-src='info/add '>
                            <i class="fa fa-plus fa-fw"></i>
                            发布文章
                        </a>
                    </li>
                    <li>
                        <a href="" data-src='info/showList '>
                            <i class="fa fa-file-text fa-fw"></i>
                            文章列表
                        </a>
                    </li>
        ...
        <div class="o-nav-item">
            ...
            <div class="o-nav-list-s">
                <ul>
                    <li>
                        <a href="javascript:;" data-src='Settings/index'>
        ...
        <!-- <div class="o-nav-item">
            ...
            <div class="o-nav-list-s">
                <ul>
                    <li>
                        <a href="javascript:;" data-src='Chart/show'>
                            <i class="fa fa-pie-chart"></i>
                            统计
                        </a>
                    </li>
        ...
        <?php if($_SESSION['admin_id']== "admin" || $_SESSION['admin_id']== "root"): ?><div class="o-nav-item" id="vo">
                <a href="javascript:;">
                ...
                <div class="o-nav-list-s">
                    <ul>
                        <li>
                            <a href="javascript:;" data-src='Config/showList'>
    ...
    <div class="o-iframe-box">
        <iframe id="iframe" name="iframe" src="" frameborder="0"></iframe>
    </div>


    <script src="/xq/Public/Admin/dist/index/index.js"></script>
    <script src="/xq/Public/vendor/qrious/qrious.js"></script>


    <script>


        srcEvent.config.url = "/xq/index.php/Admin";
        srcEvent.init();
        window['a '] = 1;
